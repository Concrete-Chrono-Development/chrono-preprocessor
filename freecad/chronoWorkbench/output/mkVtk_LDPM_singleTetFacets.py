...
def mkVtk_LDPM_singleTetFacets(geoName,tempPath,tetFacets):
    ...
    singleTetFacetPoints = tetFacets.reshape(-1,3)[round(len(tetFacets)/2)*36:round(len(tetFacets)/2)*36+36,:]
